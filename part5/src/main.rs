fn main() {
    ...
    let (product_of_nums , numbers3) = product(numbers2); // 👉 TODO call product() and put answer here
    let average_of_nums = average(numbers3); // 👉 TODO call average() and put answer here
